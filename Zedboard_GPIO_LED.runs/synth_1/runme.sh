...
HD_PWD='C:/Users/kab/Desktop/workspace/Zedboard_GPIO_LED/Zedboard_GPIO_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_gpio_led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_gpio_led_wrapper.tcl

...
HD_PWD='C:/Users/kab/Desktop/workspace/Zedboard_GPIO_LED/Zedboard_GPIO_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_gpio_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_gpio_led_wrapper.tcl -notrace
